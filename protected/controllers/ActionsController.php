...
class ActionsController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        //if ($user && $user->user_type != Users::USERTYPE_JUR_PERSON)
		...
		if(isset($_POST['Actions']))
		{
            ...
            Functions::saveIMG($_FILES['Actions']['name']['img'],'/uploads/actions/',$model);
			if($model->save())
...
//            throw new CHttpException(403, 'У вас недостаточно прав для выполнения указанного действия');
	...
	{
		$criteria = new CDbCriteria(array('order'=>'date_public DESC'));
		$dataProvider=new CActiveDataProvider('Actions', array('pagination' => array('pageSize' => 10),'criteria'=>$criteria  ));
